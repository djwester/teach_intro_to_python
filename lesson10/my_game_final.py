...
loop_delay_milliseconds = 100

time_since_last_enemy = 0
while True:
    pygame.time.delay(loop_delay_milliseconds)
    time_since_last_enemy += loop_delay_milliseconds
    time_to_delay_milliseconds = int(1000 / enemies_per_second)
    ...
    if time_since_last_enemy >= time_to_delay_milliseconds:
        time_since_last_enemy = 0
